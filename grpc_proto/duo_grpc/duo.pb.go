...
const file_duo_proto_rawDesc = "" +
	...
	"\fVideoService\x12\x1d\n" +
	"\x04Look\x12\b.Request\x1a\t.Response\"\x002,\n" +
	"\fOrderService\x12\x1c\n" +
	"\x03Buy\x12\b.Request\x1a\t.Response\"\x00B\vZ\t/duo_grpcb\x06proto3"

var (
	file_duo_proto_rawDescOnce sync.Once
	file_duo_proto_rawDescData []byte
)

func file_duo_proto_rawDescGZIP() []byte {
	file_duo_proto_rawDescOnce.Do(func() {
		file_duo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_duo_proto_rawDesc), len(file_duo_proto_rawDesc)))
	})
	return file_duo_proto_rawDescData
}

var file_duo_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_duo_proto_goTypes = []any{
...
func file_duo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_duo_proto_rawDesc), len(file_duo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   2,
